        ...
        return (
			<div className="headerinner">
				<div className="container">
					...
					<span className="mobilesearch mobile-only" onClick={this.props.toggleMenuClasses.bind(null,'showsearch')}><img src="static/img/search-white.svg"/></span>
					<div className="row">
						<div className="span4">
						...
						<div className="span8">
							<div className="headercontrols float-right">
								...
								<div className="searchbox float-left">
									...
									<span className="closesearch mobile-only" onClick={this.props.toggleMenuClasses.bind(null,'')}><img src="static/img/cross-white.svg" alt="Close"/></span>
